...
## [2026-07-30] ingest | dt670-project-handoff.md — design-conversation handoff filed into 5 topic pages + 4 ADRs

## [2026-07-30] checkpoint | KB bootstrapped from scratch; handoff ingested; next task = Arduino firmware (protocol question open). Session: [[2026-07-30-kb-bootstrap-dt670-ingest]]
...
## [2026-07-31] checkpoint | Seat current verified: 10.5 µA across F+→GND (DMM µA, empty seat) — in window, no re-trim. Cleared for real DT-670 install. Session: [[2026-07-31-seat-current-check]]
